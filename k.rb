D, [2016-07-21T18:06:17.730082 #92192] DEBUG -- :   [1m[36mActiveRecord::SchemaMigration Load (0.1ms)[0m  [1mSELECT "schema_migrations".* FROM "schema_migrations"[0m
...
ApplicationController
  ...
  GET '/account'
    shows the error page if user goes directly to /account (FAILED - 1)
...
Failures:
  ...
  1) ApplicationController GET '/account' shows the error page if user goes directly to /account
     Failure/Error: expect(last_response.body).to include('You Must <a href="/">Log In</a> to View Your Balance')
       ...
       +  </body>
       +</html>
     # ./spec/sinatra_logging_in_and_out_spec.rb:76:in `block (3 levels) in <top (required)>'

Finished in 0.56022 seconds (files took 0.86265 seconds to load)
11 examples, 1 failure

Failed examples:

rspec ./spec/sinatra_logging_in_and_out_spec.rb:74 # ApplicationController GET '/account' shows the error page if user goes directly to /account
